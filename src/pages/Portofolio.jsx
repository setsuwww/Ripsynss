...
export default function PortfolioPage() {
  ...
  return (
    <>
      ...
      <section className="relative w-full min-h-screen pt-20 pb-16 overflow-hidden bg-slate-800 dark:bg-white">
        <GridBackground />
        <BallsBackground />
      ...
      <div className="flex items-center justify-center w-full my-12 gap-4">
        ...
        <div className="flex-1 h-px bg-gradient-to-l from-transparent via-sky-500/20 dark:via-yellow-500/30 to-transparent" />
      </div>
    </>
  )
}
