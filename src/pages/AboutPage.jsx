                ...
                <div className="space-y-6">
                  {experiences.map((exp, index) => (
                    <article key={index} className="border-l-2 border-yellow-400/20 pl-6 relative">
                      ...
                      <h3 className="tracking-wide text-sm md:text-md font-semibold bg-gradient-to-r from-amber-500 to-yellow-200 bg-clip-text text-transparent inline-block" data-aos="fade-right" data-aos-duration={700 + index * 150}>
                        {exp.title}
                      </h3>
