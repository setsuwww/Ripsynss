    ...
    <header className="p-2">
      <nav
        className={clsx(
          ...
          scrolled ? "glass glass-strength-40 glass-blur-10 glass-chromatic-20 top-4 rounded-3xl border-b border-gray-400/15 inset-shadow-sm inset-shadow-gray-400/40" : "top-6"
        )}
      >
        <div className={clsx(
