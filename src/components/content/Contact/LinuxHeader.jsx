...
export default function LinuxHeader() {
  ...
  ">
    ...
    ">
          ...
          <div className="p-8 text-center">
            <div className="
        bg-gradient-to-br from-rose-500/10 to-rose-500/30
        border border-pink-700
        dark:from-rose-400/20 dark:to-rose-400/40 dark:border-pink-400
        rounded-md w-16 h-16 flex items-center justify-center mx-auto mb-4
      ">
  ...
  py-2 md:py-1.5 px-4 md:px-5
  border-b border-white/10
  bg-white/5 rounded-t-sm
  dark:bg-gray-400/10 dark:border-zinc-200
">
      <div className="flex items-center space-x-1.5 md:space-x-2">
        ...
        border border-red-700 hover:from-red-800
        dark:from-red-400 dark:to-red-500 dark:border-red-400
      "
          title="Close?"
        />
        <span className="
      w-3.5 h-3.5 rounded-full
      bg-gradient-to-b from-yellow-700 to-yellow-500
      border border-yellow-700
      dark:from-yellow-400 dark:to-yellow-500 dark:border-yellow-400
    " />
        <span className="
      w-3.5 h-3.5 rounded-full
      bg-gradient-to-b from-green-700 to-green-500
      border border-green-700
      dark:from-green-400 dark:to-green-500 dark:border-green-400
    " />
      </div>
