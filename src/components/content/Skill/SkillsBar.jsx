  ...
  return (
    <div className="glass-effect rounded-2xl p-6 outline outline-offset-4 outline-slate-500/15">
      <div className="flex justify-between items-center mb-4">
        ...
        <h3 className="hidden md:inline font-pixel text-base font-semibold text-white dark:text-slate-600">{name}</h3>
        <span className="text-sm font-medium text-slate-400 dark:text-slate-600">{level}%</span>
      </div>
