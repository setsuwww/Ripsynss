  ...
  return (
    <div className="glass-effect rounded-2xl p-6 outline outline-offset-4 outline-slate-500/15">
      <div className="flex justify-between items-center mb-4">
        <h3 className="md:hidden font-pixel text-base font-semibold text-white dark:text-slate-500">{nameSingkat ?? name}</h3>
      ...
      <div className="w-full dark:bg-slate-300 bg-slate-800 rounded-xs h-[3px] overflow-hidden">
