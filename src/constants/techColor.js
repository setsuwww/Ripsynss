export const techColors = {
  ...
  Nextjs: `
    from-slate-800/20 to-black/20 border-white/30 text-white
  ...
  Vuejs: `
    ...
    dark:from-teal-500/10 dark:to-teal-600/10 dark:border-teal-600/20 dark:text-teal-700
  `,

  Vite: `
    from-indigo-500/10 to-indigo-600/10 border-indigo-400/20 text-indigo-300
    dark:from-indigo-500/10 dark:to-indigo-600/10 dark:border-indigo-600/20 dark:text-indigo-700
  `,
